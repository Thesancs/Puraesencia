...
export default function CtaButton({ 
  ...
  return (
    <Button
      ...
      size="lg"
      className={cn(
        "w-full h-auto py-4 text-lg font-bold text-center transition-transform duration-300 ease-in-out transform rounded-lg shadow-2xl hover:scale-105 animate-pulse",
        className,
        {
          "bg-destructive hover:bg-destructive/90": status === "error",
        }
